                ...
                <div className="container">
                    <div className="row">
                       <div className="col-12 col-sm-12 col-lg-10">
                            ...
                            <h2 className="">Energy</h2>
                            <div className="indus-excerpt">
                                <p>Scriptics's Engage Platform for Utilities is a pre-architected omni-channel customer experience and billing transformation offering.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="srv-con col-12 col-sm-12 col-md-12 col-lg-12" style={{paddingTop:50}}>
                            <div className="srv-info">
                                <p className="indus-info">Through the delivery of an innovative and incredibly agile technical solution, Utilities can be assured of the level of reliability and flexibility needed to support the business into the future. As our customers move from simple cost reduction to business outcomes, we have transformed ourselves by engaging in business benefits-led outsourcing programs. We offer year on year productivity gains on not only on IT SLAs and KPIs, but also the key indicators that drive the energy business.</p>
                            </div>
                        </div>
                    </div>
                </div>
