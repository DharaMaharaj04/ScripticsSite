            ...
            <Helmet>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-sm-12 col-lg-6">
                                ...
                                <h2 className="">Amazon Elastic Kubernetes Service (EKS)</h2>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="srv-content">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-12 col-sm-12 col-md-12 col-1g-12">
                                <img className="srv-con-img" src="/assets/img/EKS-icons.png" alt="AI & Automation icon" style={{height:300,width:'100%'}}/>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="capability">
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-sm-12 col-md-12 col-1g-12">
                                <h3 className='text-center'>Getting started with Amazon EKS is easy:</h3>
                            </div>    
                            <div className="srv-capability-box col-12 col-lg-4">
                                <div className="capa_image_with_text cloud_head_with_text">
                                <h2 className="text-center cloud_text_head">1<br/>Step</h2>
                            ...
                            <div className="srv-capability-box col-12 col-lg-4">
                                <div className="capa_image_with_text cloud_head_with_text">
                                    ...
                                    <h2 className="text-center cloud_text_head">2<br/>Step</h2>
                                    </div>
                            ...
                            <div className="srv-capability-box col-12 col-lg-4">
                                <div className="capa_image_with_text cloud_head_with_text">
                                    <div className="capa_img">
                                        <h2 className="text-center cloud_text_head">3<br/>Step</h2>
                                    </div>
                            ...
                            <div className="srv-capability-box col-12 col-lg-4">
                                <div className="capa_image_with_text cloud_head_with_text">
                                    <div className="capa_img">
                                        <h2 className="text-center cloud_text_head">4<br/>Step</h2>
                                    </div>
                            ...
                            <div className="srv-capability-box col-12 col-lg-4">
                                <div className="capa_image_with_text cloud_head_with_text">
                                    <div className="capa_img">
                                        <h2 className="text-center cloud_text_head">5<br/>Step</h2>
                                    </div>
