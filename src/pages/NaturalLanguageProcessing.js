                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-sm-12 col-lg-6">
                                ...
                                <h2 className="">Natural Language Processing</h2>
                                <div className="srv-excerpt">
                                    <p>Futuristic NLP Solutions for Next-gen Interaction, Communication, and Experience</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-12 col-sm-12 col-md-6 col-1g-6">
                                <div className="srv-info">
                                    ...
                                    <p>Our NLP services assist enterprises to build futuristic digital solutions that understand human language in a better way to facilitate better business decisions.</p>
                            ...
                            <div className="srv-con col-12 col-sm-12 col-md-12 col-lg-12" style={{paddingTop:50}}>
                                <div className="srv-info">
                                    <p className="srv-info"> The following are few of the services offered – </p>
                                </div>
                            </div>
                        </div>
                    </div>
